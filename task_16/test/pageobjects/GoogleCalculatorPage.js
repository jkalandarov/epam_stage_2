class CalculatorPage {
    ...
    getCity(city) {
        return $('//md-option[contains(@ng-repeat, "item in listingCtrl.fullRegionList | filter:listingCtrl.inputRegionText.computeServer")]/div'); //$$('md-option[value="europe-west3"]')[2]
    }
    ...
    selectDivContainingText(className, text) {
        return $(`//div[contains(@class, "${className}") and contains(., "${text}")]`)
    }
